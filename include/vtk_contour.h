...
//  */
// class BUILD_TEST1_EXPORT exported_class
// {
// public:
//   /**
...
void get_result(Result*, const char* file);
...
// int get_num_verts(Result*);

// float get_positions(Result*);
